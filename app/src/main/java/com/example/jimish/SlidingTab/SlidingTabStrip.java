...
import com.example.jimish.meetupprep.Constants;
...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        defaultBottomBorderColor = setColorAlpha(themeForegroundColor,
                Constants.DEFAULT_BOTTOM_BORDER_COLOR_ALPHA);

        defaultTabColorizer = new SimpleTabColorizer();
        defaultTabColorizer.setIndicatorColors(Constants.DEFAULT_SELECTED_INDICATOR_COLOR);

        bottomBorderThickness = (int) (Constants.DEFAULT_BOTTOM_BORDER_THICKNESS_DIPS * density);
        bottomBorderPaint = new Paint();
        //bottomBorderPaint.setColor(Color.rgb(255,111,66));
        bottomBorderPaint.setColor(defaultBottomBorderColor);

        selectedIndicatorThickness = (int) (Constants.SELECTED_INDICATOR_THICKNESS_DIPS * density);
        selectedIndicatorPaint = new Paint();
        selectedIndicatorPaint.setColor(Color.rgb(255, 111, 66));
    }
